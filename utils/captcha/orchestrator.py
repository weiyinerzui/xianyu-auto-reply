...
from utils.captcha.slider_stealth import run_slider_verification, CAPTCHA_NOT_REQUIRED, URL_EXPIRED
from utils.captcha.remote_timeout import get_remote_solve_timeout
from utils.captcha.slider_mode import is_real_mouse_slider_mode
...
def _load_fallback_config() -> Tuple[bool, bool, int]:
    ...
    settings = None
    try:
        from utils.captcha.compat import get_settings
...
def run_slider_verification_with_fallback(
    ...
    if is_real_mouse_slider_mode(slider_mode):
        ...
        try:
            from utils.captcha.real_mouse_slider import (
