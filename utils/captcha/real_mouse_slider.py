...
from utils.captcha.slider_stealth import URL_EXPIRED, CAPTCHA_NOT_REQUIRED
from utils.captcha.weighted_scheduler import real_mouse_scheduler
from utils.captcha.real_mouse_coordinates import (
    build_geometry_mapper,
    compute_slider_distance,
)
from utils.captcha.windows_foreground import (
    activate_page_window,
    activate_window,
)
from utils.captcha.win_input import (
    precise_sleep,
    send_button,
    send_move_abs,
    timer_resolution,
