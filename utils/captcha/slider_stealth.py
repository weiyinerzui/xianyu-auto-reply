...
from utils.captcha.concurrency import concurrency_manager, account_browser_lock_manager
from utils.captcha.strategy_stats import strategy_stats
from utils.captcha.browser_features import get_random_browser_features, get_stealth_script
from utils.captcha.trajectory import TrajectoryGenerator
from utils.captcha.slider_elements import SliderElementFinder
from utils.captcha.verification_checker import VerificationChecker
from utils.captcha.history_manager import HistoryManager
from utils.captcha.playwright_touch import (
    SLIDER_USER_AGENT,
    configure_slider_user_agent,
    dispatch_touch_drag,
)
from utils.captcha.browser_compat import ensure_playwright_browser_path, get_chromium_executable_path, is_frozen
