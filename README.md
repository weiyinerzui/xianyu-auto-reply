...
2.  **数据隐私保护**:
    *   **彻底移除**所有外部通信代码（QQ通知、邮件API、用户统计上报）。
    *   确保用户数据仅存储在本地数据库，无任何第三方上传。
...
- 2025-12-24: 完成安全修复：移除硬编码凭证，增强API密钥管理，限制数据库下载
- 2025-12-23: 修复AI回复配置持久化问题
- 2025-12-19: 修复关键词模糊匹配设置保存问题
- 2025-12-07: 优化系统设置保存和AI测试错误处理；优化登录注册验证流程
- 2025-12-05: 商品管理添加编辑功能并优化表格显示
- 2025-12-02: 商品管理页面添加多数量发货和多规格状态切换功能
